...
class Node(abc.ABC):
    ...
    def node_hash(self) -> str:
        ...
        node_json = orjson.dumps(local_rep.to_dict(), option=orjson.OPT_SORT_KEYS)
...
class System(Node):
    ...
    def successors(
        ...
        """
        if protocol == "breadth":
            return dict(nx.bfs_successors(self.net, node, depth_limit=depth_limit))
        return dict(nx.dfs_successors(self.net, node, depth_limit=depth_limit))
...
class Subsystem(Node):
    def __init__(
        ...
        **attrs,
        ...
        super().__init__(
            _node_type, name=name, is_entity=is_entity, sub_type=sub_type, **attrs
        )
...
class Entity(Subsystem):
    def __init__(
        ...
        **attrs,
        ...
        super().__init__(
            "entity", is_entity=True, name=name, sub_type=tableize(entity_type), **attrs
        )
...
class Component(Subsystem):
    def __init__(
        ...
        **attrs,
        ...
        super().__init__(
            "component", is_entity=False, sub_type=_type, name=name, **attrs
        )
