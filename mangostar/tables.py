...
from mangostar.timescale import create_uuid
...
class MetaTableAdapter:
    def __init__(self, metadata: Optional[MetaData] = None):
        ...
        tmp_events = self.event_log
        tmp_episodes = self.episode
        tmp_sessions = self.session
        tmp_mappings = self.mappings
    ...
    def kernel(self):
        ...
        Index(
            'ix_json', _kernel.c.data, _kernel.c.tags, postgresql_using = 'gin'
        )
